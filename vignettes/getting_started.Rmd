...
knitr::include_graphics("images/QC_plots.png")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/DEGs_detected_boxplot.png")
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/FDRs_boxplot.png")
```
Down-sampling cells: <br>
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/DEGs_detected_boxplot_cells.png")
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/FDRs_cells_boxplot.png")
```
- **Effect size-specific detection rates** assess the DEG recovery across different absolute log2 fold-change bins. <br>
Down-sampling individuals: <br>
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/DEGs_downreg_effects.png")
```
Down-sampling cells: <br>
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/DEGs_cells_effects.png")
```
- **Correlation plots** assess the correlation of effect sizes for the top 500 and 1000 genes across down-sampling levels. <br>
Down-sampling individuals: <br>
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/meanCorr_downsampling_500.png")
```
Down-sampling cells: <br>
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("images/meanCorr_downsampling_cells_500.png")
```
