...
#' @param allGenes list whose elements are DGE analysis output for each celltype in a dataset (e.g. as returned by "sc_cell_type_de.R", but subsetted to "celltype_all_genes")
